...
{
	/// <summary>
	/// 	This class represents the Element dateStart
	/// </summary>
	[LiquidTechnologies.Runtime.Net40.XmlObjectInfo(LiquidTechnologies.Runtime.Net40.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"dateStart", "urn://egisso-ru/types/assignment-fact/1.0.3", true, false)]
	public partial class DateStart : schemaEgisso.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for DateStart
		/// </summary>
		/// <remarks>
		...
		public DateStart()
		{
			_elementName = "dateStart";
			Init();
		}
		public DateStart(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ns52.DateStart newObject = new ns52.DateStart(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element DateStart, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;DateStart&gt;Some Data&lt;/DateStart&gt;</BR>
		/// </remarks>
		public String Text
		{
			get
