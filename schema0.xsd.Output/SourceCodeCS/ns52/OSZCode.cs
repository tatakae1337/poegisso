...
{
	/// <summary>
	/// 	This class represents the Element OSZCode
	/// </summary>
	[LiquidTechnologies.Runtime.Net40.XmlObjectInfo(LiquidTechnologies.Runtime.Net40.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"OSZCode", "urn://egisso-ru/types/assignment-fact/1.0.3", true, false)]
	public partial class OSZCode : schemaEgisso.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for OSZCode
		/// </summary>
		/// <remarks>
		...
		public OSZCode()
		{
			_elementName = "OSZCode";
			Init();
		}
		public OSZCode(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ns52.OSZCode newObject = new ns52.OSZCode(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element OSZCode, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;OSZCode&gt;Some Data&lt;/OSZCode&gt;</BR>
		/// </remarks>
		public String Text
		{
			get
