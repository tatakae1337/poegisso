...
{
	/// <summary>
	/// 	This class represents the Element categoryID
	/// </summary>
	[LiquidTechnologies.Runtime.Net40.XmlObjectInfo(LiquidTechnologies.Runtime.Net40.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"categoryID", "urn://egisso-ru/types/assignment-fact/1.0.3", true, false)]
	public partial class CategoryID : schemaEgisso.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for CategoryID
		/// </summary>
		/// <remarks>
		...
		public CategoryID()
		{
			_elementName = "categoryID";
			Init();
		}
		public CategoryID(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ns52.CategoryID newObject = new ns52.CategoryID(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element CategoryID, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;CategoryID&gt;Some Data&lt;/CategoryID&gt;</BR>
		/// </remarks>
		public String Text
		{
			get
