...
{
	/// <summary>
	/// 	This class represents the Element ID
	/// </summary>
	[LiquidTechnologies.Runtime.Net40.XmlObjectInfo(LiquidTechnologies.Runtime.Net40.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"ID", "urn://egisso-ru/types/assignment-fact/1.0.3", true, false)]
	public partial class ID : schemaEgisso.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for ID
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ns52.ID newObject = new ns52.ID(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element ID, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;ID&gt;Some Data&lt;/ID&gt;</BR>
		/// </remarks>
		public String Text
		{
			get
