...
{
	/// <summary>
	/// 	This class represents the Element MSZ_receiver
	/// </summary>
	[LiquidTechnologies.Runtime.Net40.XmlObjectInfo(LiquidTechnologies.Runtime.Net40.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"MSZ_receiver", "urn://egisso-ru/types/assignment-fact/1.0.3", true, false)]
	public partial class MSZ_receiver : schemaEgisso.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for MSZ_receiver
		/// </summary>
		/// <remarks>
		...
		public MSZ_receiver()
		{
			_elementName = "MSZ_receiver";
			Init();
		}
		public MSZ_receiver(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_IdentityDoc = new schemaEgisso.IdentityDoc("IdentityDoc");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ns52.MSZ_receiver newObject = new ns52.MSZ_receiver(_elementName);
			...
			if (m_IdentityDoc != null)
				newObject.m_IdentityDoc = (schemaEgisso.IdentityDoc)m_IdentityDoc.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net40.ElementInfoSeqClsMnd("IdentityDoc", "urn://egisso-ru/types/prsn-info/1.0.3", LiquidTechnologies.Runtime.Net40.XmlObjectBase.XmlElementType.Element, typeof(schemaEgisso.IdentityDoc), true)]
		public schemaEgisso.IdentityDoc IdentityDoc
		{
			get 
			{ 
		...
		protected schemaEgisso.IdentityDoc m_IdentityDoc;
