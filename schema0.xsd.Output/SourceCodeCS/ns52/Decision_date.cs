...
{
	/// <summary>
	/// 	This class represents the Element decision_date
	/// </summary>
	[LiquidTechnologies.Runtime.Net40.XmlObjectInfo(LiquidTechnologies.Runtime.Net40.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"decision_date", "urn://egisso-ru/types/assignment-fact/1.0.3", true, false)]
	public partial class Decision_date : schemaEgisso.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for Decision_date
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "decision_date";
			Init();
		}
		public Decision_date(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ns52.Decision_date newObject = new ns52.Decision_date(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element Decision_date, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;Decision_date&gt;Some Data&lt;/Decision_date&gt;</BR>
		/// </remarks>
		public String Text
		{
			get
