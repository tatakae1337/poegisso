...
{
	/// <summary>
	/// 	This class represents the Element dateFinish
	/// </summary>
	[LiquidTechnologies.Runtime.Net40.XmlObjectInfo(LiquidTechnologies.Runtime.Net40.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"dateFinish", "urn://egisso-ru/types/assignment-fact/1.0.3", true, false)]
	public partial class DateFinish : schemaEgisso.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for DateFinish
		/// </summary>
		/// <remarks>
		...
		public DateFinish()
		{
			_elementName = "dateFinish";
			Init();
		}
		public DateFinish(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ns52.DateFinish newObject = new ns52.DateFinish(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element DateFinish, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;DateFinish&gt;Some Data&lt;/DateFinish&gt;</BR>
		/// </remarks>
		public String Text
		{
			get
