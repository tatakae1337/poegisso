...
{
	/// <summary>
	/// 	This class represents the Element IdentityDoc
	/// </summary>
	...
	public partial class IdentityDoc : schemaEgisso.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for IdentityDoc
		/// </summary>
		/// <remarks>
		...
		public IdentityDoc(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_PassportRF = new schemaEgisso.PassportRF("PassportRF");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ns53.IdentityDoc newObject = new ns53.IdentityDoc(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net40.ElementInfoSeqClsMnd("PassportRF", "urn://egisso-ru/types/basic/1.0.4", LiquidTechnologies.Runtime.Net40.XmlObjectBase.XmlElementType.Element, typeof(schemaEgisso.PassportRF), true)]
		public schemaEgisso.PassportRF PassportRF
		{
			...
			set 
			{ 
				Throw_IfPropertyIsNull(value, "PassportRF");
				if (value != null)
