...
{
	/// <summary>
	/// 	This class represents the Element BirthDate
	/// </summary>
	[LiquidTechnologies.Runtime.Net40.XmlObjectInfo(LiquidTechnologies.Runtime.Net40.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"BirthDate", "urn://egisso-ru/types/prsn-info/1.0.3", true, false)]
	public partial class BirthDate : schemaEgisso.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		...
		public BirthDate()
		{
			_elementName = "BirthDate";
			Init();
		}
		public BirthDate(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ns53.BirthDate newObject = new ns53.BirthDate(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element BirthDate, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;BirthDate&gt;Some Data&lt;/BirthDate&gt;</BR>
		/// </remarks>
		public String Text
		{
			get
