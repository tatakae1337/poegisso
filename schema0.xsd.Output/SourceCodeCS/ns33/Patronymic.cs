...
{
	/// <summary>
	/// 	This class represents the Element Patronymic
	/// </summary>
	[LiquidTechnologies.Runtime.Net40.XmlObjectInfo(LiquidTechnologies.Runtime.Net40.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"Patronymic", "urn://x-artefacts-smev-gov-ru/supplementary/commons/1.0.1", true, false)]
	public partial class Patronymic : schemaEgisso.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for Patronymic
		/// </summary>
		/// <remarks>
		...
		public Patronymic()
		{
			_elementName = "Patronymic";
			Init();
		}
		public Patronymic(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ns33.Patronymic newObject = new ns33.Patronymic(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element Patronymic, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;Patronymic&gt;Some Data&lt;/Patronymic&gt;</BR>
		/// </remarks>
		public String Text
		{
			get
