...
{
	/// <summary>
	/// 	This class represents the Element FirstName
	/// </summary>
	[LiquidTechnologies.Runtime.Net40.XmlObjectInfo(LiquidTechnologies.Runtime.Net40.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"FirstName", "urn://x-artefacts-smev-gov-ru/supplementary/commons/1.0.1", true, false)]
	public partial class FirstName : schemaEgisso.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		...
		public FirstName()
		{
			_elementName = "FirstName";
			Init();
		}
		public FirstName(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			ns33.FirstName newObject = new ns33.FirstName(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element FirstName, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;FirstName&gt;Some Data&lt;/FirstName&gt;</BR>
		/// </remarks>
		public String Text
		{
			get
