...
{
	/// <summary>
	/// 	This class represents the ComplexType BirthCertificate
	/// </summary>
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			schemaEgisso.BirthCertificate newObject = new schemaEgisso.BirthCertificate(_elementName);
