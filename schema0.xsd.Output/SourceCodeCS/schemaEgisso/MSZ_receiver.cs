...
{
	/// <summary>
	/// 	This class represents the ComplexType MSZ_receiver
	/// </summary>
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			schemaEgisso.MSZ_receiver newObject = new schemaEgisso.MSZ_receiver(_elementName);
