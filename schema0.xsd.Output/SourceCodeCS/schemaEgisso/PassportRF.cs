...
{
	/// <summary>
	/// 	This class represents the ComplexType PassportRF
	/// </summary>
	[LiquidTechnologies.Runtime.Net40.XmlObjectInfo(LiquidTechnologies.Runtime.Net40.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"PassportRF", "", true, false)]
	public partial class PassportRF : schemaEgisso.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for PassportRF
		/// </summary>
		/// <remarks>
		...
		public PassportRF()
		{
			_elementName = "PassportRF";
			Init();
		}
		public PassportRF(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			schemaEgisso.PassportRF newObject = new schemaEgisso.PassportRF(_elementName);
